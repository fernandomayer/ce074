...
- **09/10**: **Prova 1**.
- **12/10**: Feriado.
- **16/10**: Entrega e correção da primeira prova. Orientações para o
  experimento a ser realizado em grupo. Ver [instruções para o
  planejamento de experimentos](instrucoes-planejamento.html).
- **19/10**:
- **23/10**:
- **26/10**:
...
- **20/11**:
- **23/11**:
- **27/11**: Apresentações dos resultados dos experimentos realizados em grupo.
- **30/11**: Apresentações dos resultados dos experimentos realizados em grupo.
