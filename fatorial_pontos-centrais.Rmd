...
anova(mf)
## Note que o experimento foi reduzido para um fatorial 2^k. Devido a
## existência de falta de ajuste, o planejamento dos próximos
## experimentos deve permitir estimar efeitos quadráticos. Pode-se usar,
## por exemplo, experimentos fatoriais com pontos centrais e axiais
...
dados$lof <- dados$A^2
m1 <- lm(y ~ (A + B + C + D)^2 + lof, data = dados)
anova(m1)

## Nao tem lof, fazer a seleção e predição
```
